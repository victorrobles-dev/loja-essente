...
def criar_dados_iniciais(apps, schema_editor):
    ...
    Produto.objects.create(
        ...
        descricao='Vela artesanal com óleo essencial de lavanda francesa. Aroma suave e relaxante, ideal para momentos de tranquilidade.',
        preco=29.90,
        estoque=50,
        categoria=velas,
        aroma='Lavanda',
    ...
    Produto.objects.create(
        ...
        descricao='Difusor de canela para ambientes. Aroma quente e convidativo.',
        preco=24.90,
        estoque=25,
        categoria=difusores,
        aroma='Canela',
    ...
    Produto.objects.create(
        nome='Kit Relax',
        descricao='Kit especial com Vela de Lavanda + Sabonete de Erva Doce + Difusor de Eucalipto.',
        preco=59.90,
        estoque=15,
        categoria=kits,
        aroma='Lavanda, Erva Doce e Eucalipto',
        peso_ml='Conjunto',
        disponivel=True
    )
    ...
    Produto.objects.create(
        ...
        estoque=10,
        categoria=kits,
        aroma='Baunilha, Alecrim e Canela',
        peso_ml='Conjunto',
        disponivel=True
    )
...
class Migration(migrations.Migration):
    dependencies = [
        ('loja', '0004_alter_categoria_origem.py'), # Confirme o número da sua migration anterior
    ]
